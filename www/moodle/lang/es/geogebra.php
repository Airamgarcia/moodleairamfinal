...
/**
 * Strings for component 'geogebra', language 'es', version '3.4'.
 *
 * @package     geogebra
 * @category    string
...
$string['autograde'] = 'Actividad de autoevaluación';
...
$string['expired'] = 'Disculpe, esta actividad cerró el {$a} y ya no está disponible';
...
$string['filetype_help'] = 'Esta configuración determina como la actividad de GeoGebra se agrega al curso. Hay dos opciones:

* Subir GeoGebra - Selecciona un paquete ".ggb" válido para ser subido.
* URL externa - Permite especificar una URL. Nota: La URL debe empezar con http(s) o www y contener un archivo ".ggb" válido.';
...
<p>Por tanto, el <a href="http://www.gencat.cat/ensenyament/" target="_blank">Departament of Education of Catalonia</a> en colaboración en el <a href="http://acgeogebra.cat/" target="_blank">Catalan Association of GeoGebra</a> (ACG) y con el equipo de desarrollo de GeoGeobra han implementado este módulo que permite la incorporación de actividades GeoGebra en Moodle. Sus principales características son:
<ul>
    <li>Permite la inserción sencilla de actividades GeoGebra en cualquier curso Moodle.</li>
    ...
    <li>Los estudiante puede guardar sus actividades y continuarlas cuando lo necesiten.</li>
</ul>
</p>';
$string['modulenameplural'] = 'GeoGebra';
$string['msg_noattempts'] = 'Ha realizado esta actividad el número máximo de veces';
$string['msg_nosessions'] = 'Esta actividad GeoGebra aún no tiene una sesión';
$string['name'] = 'Nombre';
$string['noattempts'] = '-';
$string['nograding'] = 'No evaluado';
$string['nomoreattempts'] = 'No quedan más intentos para esta actividad';
$string['notopenyet'] = 'Disculpe, esta actividad no está disponible hasta {$a}';
