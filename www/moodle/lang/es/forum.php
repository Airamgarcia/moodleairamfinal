...
/**
 * Strings for component 'forum', language 'es', version '3.4'.
 *
 * @package     forum
 * @category    string
...
$string['mustprovidediscussionorpost'] = 'Debe proporcionar un ID de debate o un ID de mensaje para exportar';
...
$string['tagarea_forum_posts'] = 'Mensajes en el foro';
