...
/**
 * Strings for component 'mediagallery', language 'es', version '3.4'.
 *
...
$string['collmode_help'] = 'Esto decide si la colección estará en Moodle, o si estará enlazada a theBox. Una vez configurado, este valor no puede ser cambiado.
...
Si desea eliminar el enlace a la colección y eliminar el contenido, escriba DELETE en el cuadro de texto a continuación y haga clic en enviar.';
