...
/**
 * Strings for component 'portfolio_mahara', language 'es', version '3.4'.
 *
...
$string['err_networkingoff_help'] = 'MNet está completamente desactivado. Por favor habilítelo antes de intentar configurar este plugin. Cualquier instancia de este plugin ha sido configurada a no visible hasta que se arregle esto - necesitará volver a configurarlas a visible de nuevo manualmente. No pueden ser usadas hasta que esto pase';
