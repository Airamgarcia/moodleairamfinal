...
/**
 * Strings for component 'tool_dataprivacy', language 'es', version '3.4'.
 *
...
$string['privacyofficeronly'] = 'Solamente los usarios que tengan asignado un rol de oficial de privacidad ({$a}) tienen acceso a este contenido';
