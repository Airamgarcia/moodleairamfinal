...
/**
 * Strings for component 'tool_coursearchiver', language 'es', version '3.4'.
 *
...
$string['optoutarchivesubject'] = 'Por favor no archive mi curso';
$string['optoutby'] = 'Solicitado Por';
$string['optouthide'] = 'No ocultar este curso';
$string['optouthidesubject'] = 'Por favor no oculte mi curso';
