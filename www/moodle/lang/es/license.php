...
/**
 * Strings for component 'license', language 'es', version '3.4'.
 *
 * @package     license
 * @category    string
...
$string['cc-nc-nd'] = 'Creative Commons - No Comercial NoDerivs';
$string['cc-nc-sa'] = 'Creative Commons - No Comercial ShareAlike';
