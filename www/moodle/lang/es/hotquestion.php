...
/**
 * Strings for component 'hotquestion', language 'es', version '3.4'.
 *
 * @package     hotquestion
 * @category    string
...
$string['allowauthorinfohide_help'] = 'Si se habilita, el nombre del autor de las preguntas puede ser visible para los profesores pero oculto para los estudiantes.';
