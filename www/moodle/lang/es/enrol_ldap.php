...
/**
 * Strings for component 'enrol_ldap', language 'es', version '3.4'.
 *
 * @package     enrol_ldap
 * @category    string
...
$string['autoupdate_settings_desc'] = '<p>Seleccione los campos a actualizar cuando el script de sincronización se esté ejecutando (enrol/ldap/cli/sync.php). </p><p> Cuando al menos un campo es seleccionado, una actualización tendrá lugar.</p>';
