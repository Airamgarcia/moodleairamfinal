...
/**
 * Strings for component 'theme_boost_campus', language 'es', version '3.4'.
 *
...
$string['incoursesettingsswitchtorolesetting'] = 'Mueva "Cambiar rol a ..." a la configuración del curso';
$string['incoursesettingsswitchtorolesetting_desc'] = 'Con esta configuración, puede mover el enlace "Cambiar rol a ..." como una nueva pestaña del menú del usuario al menú del curso. El cambio de rol es una función que se utiliza en el contexto del curso y, por lo tanto, es mejor colocarlo en el menú de configuración del curso en lugar de hacerlo en el menú del usuario. <br/>
Tenga en cuenta que esta configuración no tendrá ningún efecto si no activa la opción "En el menú de configuración del curso" de arriba.';
