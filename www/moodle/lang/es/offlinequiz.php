...
/**
 * Strings for component 'offlinequiz', language 'es', version '3.4'.
 *
 * @package     offlinequiz
 * @category    string
...
$string['configdecimalplaces'] = 'Número de dígitos decimales a mostrar a la hora de mostrar las notas para el cuestionario offline.';
...
$string['nogradesseelater'] = 'Este cuestionario no ha sido calificacdo todavía para {$a}. Los resultados serán plublicados aquí.';
...
$string['printstudycodefield'] = 'Imprimir el código de estudio en la hoja de preguntas';
...
$string['regradinginfo'] = 'Si usted cambia la puntuación de una pregunta, debe recalificar el cuestionario offline para actualizar los resultados de los participantes.';
