...
/**
 * Strings for component 'assign', language 'es', version '3.4'.
 *
 * @package     assign
 * @category    string
...
$string['nomoresubmissionsaccepted'] = 'Sólo permitido para participantes que hayan obtenido una prórroga';
$string['none'] = 'Ninguna';
