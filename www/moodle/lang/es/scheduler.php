...
/**
 * Strings for component 'scheduler', language 'es', version '3.4'.
 *
 * @package     scheduler
 * @category    string
...
$string['emailreminder'] = 'Mandar un recordatorio por correo electrónico';
...
$string['field-studentusername'] = 'Nombre de usuario del estudiante';
...
Los archivos CSV pueden abrirse en la mayoría de las aplicaciones de hojas de cálculo;</li>
<li>Archivos de Microsoft Excel (formato Excel 2007);</li>
<li>Hojas de Cálculo (Spreadsheets) Open Document (ODS);</li>
...
$string['messagesent'] = 'Mensaje enviado a {$a} receptores';
$string['messagesubject'] = 'Asunto';
$string['minutes'] = 'minutos';
$string['minutesperslot'] = 'minutos por espacio';
$string['missingstudents'] = '{$a} estudiantes todavía necesitan reservar una cita';
$string['missingstudentsmany'] = '{$a} estudiantes todavía necesitan reservar una cita. No se despliega la lista debido a su tamaño.';
...
$string['mode'] = 'Modo';
$string['modeappointments'] = 'reserva(s)';
$string['modeintro'] = 'Los estudiantes pueden registrar';
$string['modeoneatatime'] = 'a la vez';
$string['modeoneonly'] = 'en este planificador de citas';
$string['modulename'] = 'Planificador de citas';
$string['modulename_help'] = 'La actividad de planificador de citas  te ayuda para organizar citas con tus estudiantes.

Los profesores especifican las horas y fechas para los espacios, los estudiantes entonces eligen una de ellas en Moodle. Los profesores a su vez pueden registrar el resultado de la reunión-
y opcionalmente una calificación- dentro del planificador.

Si se admite la reserva por grupos; esto es, en cada hora y fecha se puedan inscribir varios alumnos, y opcionalmente es posible reservar citas para grupos completos al mismo tiempo.';
$string['modulename_link'] = 'mod/scheduler/view';
$string['modulenameplural'] = 'Planificadores de citas';
$string['monday'] = 'Lunes';
$string['multiple'] = '(múltiple)';
$string['myappointments'] = 'Mis citas';
$string['myself'] = 'Yo mismo';
$string['name'] = 'Nombre del planificador de citas';
...
$string['noexistingstudents'] = 'No hay estudiantes disponibles';
$string['nogroups'] = 'No hay grupos disponibles';
$string['noresults'] = 'Sin resultados.';
$string['noschedulers'] = 'No hay programadores de citas';
$string['noslots'] = 'No hay espacios disponibles.';
$string['noslotsavailable'] = 'No hay espacios disponibles para la reserva en este momento.';
$string['noslotsopennow'] = 'No hay espacios abiertos ahora mismo.';
...
$string['noteacherforslot'] = 'No hay profesor para los espacios';
$string['noteachershere'] = 'No hay profesor disponible';
$string['notenoughplaces'] = 'Lo sentimos, no hay suficientes citas libres en este espacio.';
...
$string['notifications_help'] = 'Cuando se habilita esta opción, los docentes y estudiantes recibirán notificaciones de cuando se solicitan o cancelan citas.';
$string['notseen'] = 'No visto';
$string['now'] = 'Ahora';
$string['occurrences'] = 'Sucesos';
$string['odsformat'] = 'ODS';
$string['on'] = 'en';
$string['onedaybefore'] = '1 día antes del espacio';
$string['onelineperappointment'] = 'Una línea por cita';
$string['onelineperslot'] = 'Una línea por espacio';
$string['oneslotadded'] = '1 espacio añadido';
$string['oneslotdeleted'] = '1 lugar eliminado';
$string['oneweekbefore'] = '1 semana antes de la fecha para el espacio';
$string['onthemorningofappointment'] = 'En la mañana de la cita';
$string['options'] = 'Opciones';
$string['otherstudents'] = 'Otros participantes';
$string['outlineappointments'] = '{$a->attended} citas atendidas, {$a->upcoming} próximas.';
$string['outlinegrade'] = 'Calificación: {$a}.';
$string['overall'] = 'Total';
$string['overlappings'] = 'Otros espacios se solapan';
$string['pageperteacher'] = 'Una página por cada {$a}';
$string['pagination'] = 'Paginación';
$string['pagination_help'] = 'Elegir si la exportación debería contener una página separada para cada profesor.
En formatos Excel y ODS, estas páginas corresponden a pestañas (hojas de trabajo) en el libro.';
$string['pdfformat'] = 'PDF';
$string['pdforientation'] = 'Orientación de página PDF';
$string['pluginadministration'] = 'Administración del planificador de citas';
$string['pluginname'] = 'Planificador de citas';
$string['portrait'] = 'Foto';
...
$string['registeredlbl'] = 'Estudiante designado';
...
$string['resetslots'] = 'Eliminar espacios del programador';
$string['return'] = 'Regresar al curso';
$string['revoke'] = 'Revocar la cita';
$string['saturday'] = 'Sábado';
$string['save'] = 'Guardar';
$string['savechoice'] = 'Guardar mi elección';
$string['saveseen'] = 'Guardar lo visto';
$string['schedule'] = 'Programación';
$string['scheduleappointment'] = 'Cita para {$a}';
$string['schedulecancelled'] = '{$a} : Tu cita ha sido cancelada o movida';
$string['schedulegroups'] = 'Programar por grupo';
$string['scheduleinnew'] = 'Programar en un espacio nuevo';
$string['scheduleinslot'] = 'Programar en espacio';
$string['scheduler'] = 'Programdor de citas';
$string['scheduler:addinstance'] = 'Añadir un nuevo programador de citas';
$string['scheduler:appoint'] = 'Reservar espacios';
$string['scheduler:attend'] = 'Asistir a los estudiantes';
$string['scheduler:canscheduletootherteachers'] = 'Programar citas para otros miembros del personal';
$string['scheduler:canseeotherteachersbooking'] = 'Ver y ojear las reservas de otros profesores';
$string['scheduler:disengage'] = 'Esta funcionalidad está obsoleta y no hace nada';
$string['scheduler:manage'] = 'Gestionar sus espacios y citas';
$string['scheduler:manageallappointments'] = 'Administrar todos los datos del planificador de citas';
$string['scheduler:seeotherstudentsbooking'] = 'Ver otros estudiantes con reserva en el espacio';
...
$string['yourappointmentnote'] = 'Comentarios sólo para ti';
$string['yourslotnotes'] = 'Comentarios sobre la reunión';
