...
/**
 * Strings for component 'report_performance', language 'es', version '3.4'.
 *
...
$string['privacy:metadata'] = 'El plugin de vista general del rendimiento no almacena ningún dato personal.';
$string['value'] = 'Valor';
