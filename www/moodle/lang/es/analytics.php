...
/**
 * Strings for component 'analytics', language 'es', version '3.4'.
 *
 * @package     analytics
 * @category    string
...
$string['errorendbeforestart'] = 'La fecha de finalización ({$a}) es anterior a la fecha de inicio del curso.';
