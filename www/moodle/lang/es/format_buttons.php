...
/**
 * Strings for component 'format_buttons', language 'es', version '3.4'.
 *
...
<strong>Arriba de la lista de botones</strong><br>Use esta opción si Usted desea añadir algun texto o recurso antes de la lista de botones.
