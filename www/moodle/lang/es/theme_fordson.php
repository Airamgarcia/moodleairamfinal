...
/**
 * Strings for component 'theme_fordson', language 'es', version '3.4'.
 *
...
$string['bodycolor'] = 'Color de texto predeterminado';
$string['bodycolor_desc'] = 'Color de texto predeterminado.';
...
$string['brandgray_desc'] = 'Ajuste del gris base - Es el color utilizado para crear tonos grises. El valor por defecto será # 000, pero se puede adaptar si se necesita ajustar los niveles de contraste';
...
$string['coursemanagementinfodesc'] = 'Estos ajustes permiten mostrar un menú, fácil de usar, de gestión de cursos para los profesores. Este menú de gestión del curso incluye ahora el menú desplegable Este Curso, un panel deslizante de administración del curso y la capacidad de incluir el encabezado de edición del curso predeterminado de Moodle.';
...
$string['coursemanagementtoggle'] = 'Mostrar los paneles de alumnos y profesores';
$string['coursemanagementtoggle_desc'] = 'Muestra un panel deslizante fácil de usar para que los profesores puedan manejar su curso. También mostrará un panel de resumen del curso para los estudiantes con calificaciones, finalización del curso y otros elementos del curso.';
$string['coursestaff'] = 'Profesores del curso';
$string['coursestyle1'] = 'Estilo Uno';
$string['coursestyle2'] = 'Estilo Dos';
$string['coursestyle3'] = 'Estilo Tres';
$string['coursestyle4'] = 'Estilo Cuatro con resumen del curso';
...
$string['coursetilestyle_desc'] = 'Al ver las categorías de los cursos, puedes elegir entre los siguientes estilos para mostrar los cursos.';
...
$string['enablefrontpageavailablecoursebox'] = 'Habilitar visualización mejorada del curso';
$string['enablefrontpageavailablecoursebox_desc'] = 'La visualización mejorada del curso mostrará los cursos en mosaico y utilizará iconos en una vista de cuadrícula para las categorías de curso. Para utilizar la presentación predeterminada de Moodle, desmarcar esta opción.';
$string['enrollcoursecard'] = 'Inscribirse';
...
$string['footerbg'] = 'Color de fondo del pie de página';
$string['footerbg_desc'] = 'El color de fondo del pie de página.';
...
$string['fpicon-colour'] = 'Color del enlace del icono de página de inicio';
$string['fpicon-colour_desc'] = 'Color de los enlaces de los iconos de navegación.';
$string['fpiconnavbg'] = 'Color del fondo del botón icono de la página principal';
$string['fpiconnavbg_desc'] = 'Color del fondo del botón icono.';
$string['fpiconnavhover'] = 'Fondo del icono de la página principal';
$string['fpiconnavhover_desc'] = 'Color de fondo cuando se pasa el ratón sobre el icono en la barra de navegación de la página de inicio.';
...
$string['fpstartwrap'] = 'Fondo del icono de navegación de la página principal';
$string['fpstartwrap_desc'] = 'Color de fondo de la barra de navegación de iconos.';
...
$string['headercolor'] = 'Color del Texto Cabecera Página';
$string['headercolor_desc'] = 'Modifica el color de la cabecera de página H1 de forma que pueda resaltar mejor por encima de la imagen de la cabecera.';
...
$string['headericon'] = 'Icono título cabecera';
$string['headericon_desc'] = 'Permite cambiar el icono que aparece en el área de encabezado junto al título de la página. Son iconos Font-Awesome.';
...
$string['headerscreen'] = 'Color de fondo de la cabecera';
$string['headerscreen_desc'] = 'Color de fondo que aparece debajo del texto en el área de la imagen del encabezado. Es para ayudar a hacer que el texto y la ruta de navegación destaquen cuando se utiliza una imagen en el encabezado.';
$string['headingcolor'] = 'Colores de los encabezados';
$string['headingcolor_desc'] = 'Ajustes de color de H1,H2,H3,H4,H5,H6.';
$string['headingfont'] = 'Selector de fuente de títulos';
$string['headingfont_desc'] = 'Elegir una fuente de Google que se utilizará para todos los títulos.';
...
$string['linkcolor'] = 'Color por defecto de los enlaces';
$string['linkcolor_desc'] = 'Color por defecto de los enlaces.';
...
$string['marketingicondesc'] = 'Nombre del icono que quieres que se utilice en el botón URL del anuncio. La lista está <a href="http://fortawesome.github.io/Font-Awesome/cheatsheet/" target="_new">aquí</a>. Solo introduce lo que está después de "fa-", e.g. "star".';
...
$string['navbarbkg'] = 'Color de fondo de la barra de navegación superior';
$string['navbarbkg_desc'] = 'Color de fondo de la barra fija superior de navegación.';
$string['navbarurl'] = 'Color de los enlaces de la barra de navegación superior';
$string['navbarurl_desc'] = 'Colores de los enlaces y el menú de la barra fija superior de navegación.';
...
$string['navicondesc'] = 'Nombre del icono que quieres que se utilice. La lista está <a href="http://fortawesome.github.io/Font-Awesome/cheatsheet/" target="_new">aquí</a>. Introduce solo lo que está después de "fa-", e.g. "star".';
$string['naviconslidedesc'] = 'Texto del icono sugerido: arrow-circle-down. O escoge uno de la lista que está <a href="http://fortawesome.github.io/Font-Awesome/cheatsheet/" target="_new">aquí</a>. Introduce solo lo que está después de "fa-", e.g. "star".';
$string['noenrolments'] = 'Ahora mismo no tiene matriculaciones';
$string['nomycourses'] = 'No estás inscrito en ningún curso.';
$string['pagefont'] = 'Selector de fuente de la página';
$string['pagefont_desc'] = 'Eligir una fuente para el texto de la página.';
...
$string['preset_desc'] = 'Elige un ajuste predefinido para cambiar totalmente el aspecto del tema.';
...
$string['sectionicon'] = 'Icono de la sección del curso';
$string['sectionicon_desc'] = 'Permite cambiar el icono que aparece junto a cada tema/semana de un curso. Son iconos Font-Awesome.';
...
$string['showbacktotop'] = 'Mostrar el botón de Volver arriba y activar el Scrollspy';
$string['showbacktotop_desc'] = 'Activa el botón de volver arriba en páginas largas. Scrollspy devolverá al profesor a su posición en la página del curso al activar y desactivar la edición. Estas son mejoras de usabilidad para los usuarios.';
...
$string['sociallinkicondesc'] = 'Introduce el nombre fontawesome para el icono de su enlace<br />Puede encontrar la lista completa de iconos FontAwesome en http://fontawesome.io/icons/';
