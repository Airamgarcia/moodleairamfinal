...
/**
 * Strings for component 'zoom', language 'es', version '3.4'.
 *
 * @package     zoom
 * @category    string
...
$string['apikey_desc'] = 'JWT será deprecado en junio del 2023';
$string['apisecret'] = 'Secreto de la API de Zoom';
$string['apisecret_desc'] = 'JWT será deprecado en junio del 2023';
...
$string['err_invalid_password'] = 'La contraseña contiene caracteres no permitidos.';
...
$string['err_password_required'] = 'La contraseña está marcada como obligatoria, pero el campo Contraseña está vacío.';
...
$string['licensesnumber'] = 'Numero de licencias';
...
$string['maskparticipantdata'] = 'Enmascarar datos de los participantes';
...
$string['option_authenticated_users'] = 'Solo usuarios autenticados';
...
$string['option_mute_upon_entry'] = 'Silenciar en la entrada';
$string['option_mute_upon_entry_help'] = 'Silenciar automáticamente a todos los participantes cuando se unan a la reunión. El anfitrión controla si los participantes pueden reactivar su propio audio.';
