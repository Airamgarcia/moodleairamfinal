...
/**
 * Strings for component 'message', language 'es', version '3.4'.
 *
 * @package     message
 * @category    string
...
$string['removefromyourcontacts'] = 'Eliminar de tus contactos';
...
$string['togglemessagemenu'] = 'Mostrar/ocultar menú de mensajes';
...
$string['viewinganotherusersmessagearea'] = 'Está viendo el área de mensajes de otro usuario.';
