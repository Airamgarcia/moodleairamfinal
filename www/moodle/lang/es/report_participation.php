...
/**
 * Strings for component 'report_participation', language 'es', version '3.4'.
 *
...
$string['privacy:metadata'] = 'El plugin de participación en curso no almacena ningún dato personal.';
