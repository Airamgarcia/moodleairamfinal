...
/**
 * Strings for component 'filter_filtercodes', language 'es', version '3.4'.
 *
...
$string['coursecontactlinktype_desc'] = 'Seleccione el tipo de enlace de contacto para el enlace de contacto en las etiquetas {coursecontacts}.';
