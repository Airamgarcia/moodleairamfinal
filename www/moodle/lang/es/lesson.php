...
/**
 * Strings for component 'lesson', language 'es', version '3.4'.
 *
 * @package     lesson
 * @category    string
...
$string['firstwrong'] = 'Respuesta incorrecta. ¿Desea intentarlo de nuevo? (Si responde correctamente ahora,  no contará en su nota final)';
...
$string['groupsnone'] = 'No existen grupos en este curso';
...
$string['noanswer'] = 'Hay preguntas sin respuesta. Por favor, vuelva atrás y entregue una respuesta.';
