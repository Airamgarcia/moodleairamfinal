...
/**
 * Strings for component 'plagiarism_turnitin', language 'es', version '3.4'.
 *
...
$string['errorcode4'] = 'Debe subir un archivo de un tipo soportado. Los tipos soportados son:  .doc, .docx, .ppt, .pptx, .pps, .ppsx, .pdf, .txt, .htm, .html, .hwp, .odt, .wpd, .ps and .rtf';
