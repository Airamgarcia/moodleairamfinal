...
/**
 * Strings for component 'report_usersessions', language 'es', version '3.4'.
 *
...
$string['privacy:metadata'] = 'El plugin de informe de sesiones de usuario no almacena ningún dato personal.';
