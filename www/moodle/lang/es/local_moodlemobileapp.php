...
/**
 * Strings for component 'local_moodlemobileapp', language 'es', version '3.4'.
 *
...
$string['core.ajaxendpointnotfound'] = '<p>AJAX endpoint not found. Esto puede ocurrir si su sitio Moodle es muy antiguo o no se puede conectar. La app solamente puede conectar a sitios Moodle cuya versión sea mayor o igual que {{$a}}. Por favor contacte al administrador de su sitio.</p>
<p>{{whoisadmin}}</p>';
...
$string['core.certificaterror'] = '<p>El certificado de seguridad del sitio no es de confianza. Por favor contacte a su administrador.</p>
<p>{{whoisadmin}}</p>';
