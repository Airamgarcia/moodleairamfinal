...
/**
 * Strings for component 'atto_recordrtc', language 'es', version '3.4'.
 *
...
$string['allowedtypes_desc'] = 'Qué botones de grabación deben aparecer en Atto';
$string['annotation:audio'] = 'Anotación de Audio';
$string['annotation:video'] = 'Anotación de video';
$string['annotationprompt'] = '¿Como qué deberían de aparecer las anotaciones de audio?';
$string['attachrecording'] = 'Adjuntar Grabación como Anotación';
...
$string['audiortc'] = 'Insertar grabación de audio';
$string['both'] = 'Audio y Video';
$string['browseralert'] = 'Use Firefox >= 29, Chrome >= 49 u Opera >= 36 para una mejor experiencia';
$string['browseralert_title'] = '¡Advertencia!';
...
$string['videortc'] = 'Insertar grabación de video';
