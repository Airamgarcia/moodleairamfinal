...
/**
 * Strings for component 'local_staticpage', language 'es', version '3.4'.
 *
...
$string['documentnavbarsource'] = 'Origen de los datos del título del elemento "migas de pan" (barra de navegación)';
