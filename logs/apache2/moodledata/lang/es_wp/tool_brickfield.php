...
/**
 * Strings for component 'tool_brickfield', language 'es_wp', version '4.3'.
 *
...
$string['activationheader'] = 'Registro en Brickfield';
...
$string['brickfield:viewsystemtools'] = 'Ver informes por cursos';
...
$string['contentyperesults'] = 'Total superado/ no superado por áreas de contenido por curso.';
...
$string['error:nocoursespecified'] = 'Este informe resumen requiere una id de curso válida. Acceda al Kit de Accesibilidad desde dentro de un curso, a través del Menú de acciones, para poder proporcionar la id de curso requerida.';
...
$string['privacy:metadata'] = 'La extensión de Informe de comprobaciones de accesibilidad no almacena ningún dato personal.';
